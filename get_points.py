...
def run(im, multi=False):
    im_disp = im.copy()
    im_draw = im.copy()
    window_name = "Please select objects to be tracked."
    ...
    print "If you have do the selection, press 't' to start the tracking points."
    print "If you want to reselect, press 'd' to discard."
    print "If you want to quit, press 'q' to quit."
